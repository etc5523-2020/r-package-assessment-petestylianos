...
ui <- fluidPage(
  titlePanel(windowTitle = "Covid Analytics",
             title = fluidRow(
               ...
               font-size: 40px;
               font-weight:bold;">COVID Analytics<span>'),
               align = "center")
  ),
  ...
  navbarPage(footer =  HTML('<span style="color:black;
                            font-size: 20px;
                            font-weight:bold;">
                            <a href="https://cwd.numbat.space/" target="_blank">
                            ETC5523: Communicating with Data</a><span>'),
        ...
        table.dataTable  {color:black; font-size:18px; background-color:#ffecef}")
             ...
             tabPanel("Cases by Country", icon = icon("globe"),
                      ...
                      tags$div("Hover over points to see the popup with the number of total cases.",
                               style = "color:black;font-size: 20px;font-weight:normal;"
                      ),

                      spinner(leafletOutput("map", height = "800px")),
                      n_br(2),
                      HTML('<span style="color:navy;font-size: 25px; font-weight:bold;">
                      ...
                      HTML('<span style="color:black;font-size:20px;font-weight:normal;">
                           Death Rate was calculated as the percentage of total deaths among
                           total cases. <br> Infected Rate was calculated as the percentage
                           of infected citizens divided by the population of the country.<br><span>'
                      ),
                      br(),
                      spinner(DT::dataTableOutput("country_stats")),
                      br(),
                      HTML('<span style="color:black;font-size: 20px;font-weight:normal;">
                      ...
                      n_br(2),
                      my_layout(id = "case_country",
                                x = covid_all$country,
                                output = plotOutput("stats", height = "600px"),
                                input_option = sliderTextInput("scale",
                                                               label = h4("Select Scale", style = "color:navy"),
                                                               choices = c("Logarithmic", "Identity"),
                                                               selected = "Identity",
                                                               width = "200px")
                      )
             ),
             ...
             tabPanel("Apple Analytics", icon = icon("apple"),
                      ...
                      br(),
                      my_layout(id = "country",
                                x =covid_city$country,
                                output = plotOutput("city", height = "750px")
                      )
             ),
             ...
             tabPanel("Google Analytics", icon = icon("google") ,
                      ...
                      br(),
                      my_layout(id = "google_country",
                                x = covid_all$country,
                                output = plotOutput("google",height = "750px")
                      )
             ),
             tabPanel("Measures", icon = icon("book"),
                      ...
                      br(),
                      my_layout(id = "meas_country",
                                x = covid_all$country,
                                output = plotlyOutput("measure",height = "600px")
                      ),
                      hr(),
                      n_br(2),
                      tags$div(
